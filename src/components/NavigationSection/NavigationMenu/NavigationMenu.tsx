...
import {refsService, uriHeader} from "../../../services";
...
const NavigationMenu: FC<NavigationMenuProps> = ({active, onClick}) => {
            ...
            <div className="menu-nav">
                ...
                <ul className={"menu-list" + (active ? " open" : "")}>
                    {uriHeader.map(header => {
                        const category = header.category ? refsService.getCategoryById(categories, header.category) : null;
